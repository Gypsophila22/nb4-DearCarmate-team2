...
import { validate } from '../customers/middlewares/validate.middleware.js'; // validate 미들웨어 임포트
import { customerValidation } from '../customers/schemas/index.js'; // customerValidation 스키마 임포트
