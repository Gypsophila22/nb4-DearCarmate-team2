...
async function main() {
  ...
  await prisma.customers.createMany({
    data: [
      { name: '김민준', email: 'minjun.kim@example.com', gender: 'male', phoneNumber: '010-1234-5678', region: '서울', ageGroup: 'GENERATION_30', memo: '첫 번째 고객', contractCount: 2, companyId: company.id },
      { name: '이서연', email: 'seoyeon.lee@example.com', gender: 'female', phoneNumber: '010-2345-6789', region: '부산', ageGroup: 'GENERATION_20', memo: '두 번째 고객', contractCount: 1, companyId: company.id },
      { name: '박지훈', email: 'jihoon.park@example.com', gender: 'male', phoneNumber: '010-3456-7890', region: '인천', ageGroup: 'GENERATION_40', memo: '세 번째 고객', contractCount: 3, companyId: company.id },
      { name: '최수아', email: 'sua.choi@example.com', gender: 'female', phoneNumber: '010-4567-8901', region: '대구', ageGroup: 'GENERATION_20', memo: '네 번째 고객', contractCount: 0, companyId: company.id },
      { name: '정도윤', email: 'doyoon.jung@example.com', gender: 'male', phoneNumber: '010-5678-9012', region: '광주', ageGroup: 'GENERATION_30', memo: '다섯 번째 고객', contractCount: 1, companyId: company.id },
      { name: '윤채원', email: 'chaewon@example.com', gender: 'female', phoneNumber: '010-6789-0123', region: '대전', ageGroup: 'GENERATION_20', memo: 'VIP 고객', contractCount: 5, companyId: company.id },
      { name: '임도현', email: 'dohyun@example.com', gender: 'male', phoneNumber: '010-7890-1234', region: '울산', ageGroup: 'GENERATION_50', memo: '재방문 고객', contractCount: 2, companyId: company.id },
      { name: '백하윤', email: 'hayoon@example.com', gender: 'female', phoneNumber: '010-8901-2345', region: '강원', ageGroup: 'GENERATION_30', memo: '신규 상담', contractCount: 0, companyId: company.id },
      { name: '송은우', email: 'eunwoo@example.com', gender: 'male', phoneNumber: '010-9012-3456', region: '울산', ageGroup: 'GENERATION_40', memo: '소개 고객', contractCount: 1, companyId: company.id },
